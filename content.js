...
function actionNotInterested(ev) {
  ...
  gridItem.querySelector(".dropdown-trigger").click();
...
function addNotInterestedToEl(
  ...
  try {
    ...
    var videoElements = document.querySelectorAll(".ytd-watch-next-secondary-results-renderer")[1].querySelectorAll(".ytd-watch-next-secondary-results-renderer");
                                    

    //  console.log("last count " + lastCount + " / videoElements " + videoElements );
    ...
    for (var i = 0; i < videoElements.length; ++i) {
      ...
      if ( videoElements[i].tagName === "YTD-COMPACT-PLAYLIST-RENDERER") {
      ...
      insertEl.appendChild(document.createElement('div'));
